...
class Slab(AtomCollection):
    ...
    def __init__(self,label,atom_list,a0,lattice_vectors,vaccuum=10.0):
        ...
        if lattice_vectors.shape[0]==3 and lattice_vectors.size==9:
            ...
            raise SlabError("'lattice_vectors' must be a Numpy array with three vectors!")
    ...
    def displace(self,disp,update=True,update_owner=True):
        ...
        update_owner : logical, optional
            ...
            the slab eventually belongs. The default is True.
        '''
    ...
    def write_pw_input(self,file_name="slab.in",ucell=False,pseudopotentials={},
                       pwargs={}):
        '''
    ...
    def _update(self):
        ...
        '''        
        valid_coords=array([atom._x for atom in self._atoms if atom._active and
