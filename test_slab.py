...
print("Total number of active atoms before modification: %d" 
      % len(graphene2.active_atoms))

graphene2[8].active=False
graphene2[24].active=False
graphene2.remove_atom(66)

print("Total number of active atoms after modification: %d" 
      % len(graphene2.active_atoms))

graphene2.write_xyz("graphene.5.xyz")
graphene2.write_pw_input("graphene2.1.in",pseudopotentials={"C":"C.paw.UPF",
                                                            "H":"H.paw.UPF"})
...
bridge1_pos=np.array([0.0,(graphene[1].coords[1]+
             (graphene[2].coords[1]-graphene[1].coords[1])/2.0)])

graphene.add_adsorption_site("top1",top1_pos)
graphene.add_adsorption_site("bridge1",bridge1_pos)

h1=Atom("H",x=np.array([graphene.adsorption_sites["top1"][0],
                       graphene.adsorption_sites["top1"][1],
                       1.0]))
h2=Atom("H",x=np.array([graphene.adsorption_sites["bridge1"][0],
